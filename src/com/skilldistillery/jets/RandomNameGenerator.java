...
public class RandomNameGenerator {
	...
	private static final String[] FIRST_NAMES = { "John", "Alice", "Bob", "Eva", "Charlie", "Olivia", "Leigh", "Cora",
			"Dom" };
	private static final String[] LAST_NAMES = { "Smith", "Johnson", "Williams", "Brown", "Jones", "Baron", "Rodrigo",
			"Allen" };
